...
OUT_DIR = Path("/Users/amritanagasuri/Desktop/new Q-TOF Analysis/2. imput-PCA/PCA Batch Removal - REDO/StatsDiffEnrichm_0 output")
OUT_DIR.mkdir(parents=True, exist_ok=True)
# --------------------------------

df = pd.read_csv('/Users/amritanagasuri/Desktop/new Q-TOF Analysis/2. imput-PCA/PCA Batch Removal - REDO/pos+neg_proteoBatchCorrPCA output/Pos_ProteoBatchCorrected_data.csv')
...
loc3 = df.loc[:, df.columns.str.contains('_r1')]
loc3.columns = loc3.columns.str.replace('_r1', '')
...
# --- Save to desired directory (CHANGED) ---
out_path = OUT_DIR / 'PosPVFStats2c.csv'
mts.to_csv(out_path)  # preserving original behavior (writes index)
