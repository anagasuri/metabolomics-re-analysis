...
# --- ADDED: output folder for all figures ---
from pathlib import Path
OUT = Path("/Users/amritanagasuri/Desktop/new Q-TOF Analysis/2. imput-PCA/Before BC/PCA+other variables.py output")
OUT.mkdir(parents=True, exist_ok=True)
# ------------------------------------------------

df1 = pd.read_csv('/Users/amritanagasuri/Desktop/new Q-TOF Analysis/final pos, neg, pheno/Neg_Clean_NEWWITHREPS.csv')
df2 = pd.read_csv('/Users/amritanagasuri/Desktop/new Q-TOF Analysis/final pos, neg, pheno/Pos_Clean_NEWWITHREPS.csv')
...
df.to_csv('/Users/amritanagasuri/Desktop/new Q-TOF Analysis/2. imput-PCA/Before BC/PCA+other variables.py output/PCA_components.csv')
